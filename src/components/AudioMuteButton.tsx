...
const AUDIO_MUTED_KEY = "service-compris-audio-muted";
...
export function AudioMuteButton() {
  ...
  return (
    <button
      type="button"
      onClick={toggle}
      className="pointer-events-auto fixed bottom-4 right-4 z-[200] flex h-11 w-11 items-center justify-center rounded-xl border-2 border-[#141414]/20 bg-white/95 text-[#141414] shadow-[3px_3px_0_0_rgba(20,20,20,0.15)] backdrop-blur-sm transition-colors hover:border-[#141414]/35 hover:bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[#141414] focus-visible:ring-offset-2 focus-visible:ring-offset-white"
