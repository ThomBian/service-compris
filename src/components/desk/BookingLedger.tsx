...
export const BookingLedger: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 min-h-0 bg-white rounded-[10px] flex flex-col gap-2 overflow-hidden">
      <div className="flex items-center gap-1.5 shrink-0 px-3 pt-3">
        <Book size={12} />
